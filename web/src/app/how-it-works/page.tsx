  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Заявка появляется в кабинете специалиста, и дальше всё общение идёт прямо на площадке — в разделе «Мои заявки» открывается чат с историей переписки. Когда договоритесь об условиях, обе стороны нажимают «Заключить сделку» — результат, стоимость и срок фиксируются отдельной записью, и заказ переезжает в раздел «Заказы».",
      },
      {

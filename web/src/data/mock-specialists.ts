...
const TEMPLATES: Array<{
  ...
  // Добавлены 2026-08-22 как второй продавец на пару типов результата
  // (web/src/data/mock-services.ts) — чтобы показать сравнение "тот же
  // товар, разные исполнители", как на Playerok. Приписаны в конец
  // массива намеренно: buildMockSpecialists() ниже проходит шаблоны по
  // индексу без остатка, пока индекс меньше длины массива, так что
  // specialist-1..10 остаются как были, а specialist-11/12 — новые, не
  // повтор через модуль.
  {
    name: "Кирилл Орлов",
    title: "AI-агенты для малого бизнеса",
    shortDescription:
      "Собираю AI-агентов для продаж и заявок на бюджете небольшого бизнеса — без лишних интеграций и переплаты за корпоративный масштаб.",
    fullDescription:
      "Работаю в одиночку, поэтому дешевле студии, но закрываю тот же результат для небольшого бизнеса: AI-агент отвечает на заявки в Telegram или на сайте, квалифицирует клиента и передаёт менеджеру. Не берусь за сложные корпоративные интеграции — специализируюсь на быстром запуске без лишних затрат.",
    category: "ai-agents",
    skills: ["GPT-4", "Make", "Telegram", "Webhooks"],
    priceFrom: "От 35 000 ₽ за проект",
    experienceYears: 2,
    responseTime: "Отвечает в течение дня",
    location: "Удалённо",
    ...
    reviews: [
      {
        author: "Настя, локальная кофейня-франшиза",
        rating: 5,
        text: "Для нашего масштаба студии были избыточны по цене — Кирилл сделал ровно то, что нужно, и уложился в бюджет.",
      },
    ],
  },
  {
    ...
    shortDescription:
      "Делаю Telegram-ботов с оплатой и записью на услуги — быстрый запуск по готовым шаблонам сценариев.",
    fullDescription:
      "Специализируюсь на Telegram-ботах для малого и среднего бизнеса: приём оплаты, запись на услуги, консультации на базе GPT. Использую отработанные шаблоны сценариев, поэтому запускаю быстрее студии, но без потери качества диалога.",
    category: "chatbots",
    skills: ["Telegram", "GPT", "ЮKassa", "Python"],
    priceFrom: "От 38 000 ₽ за проект",
    experienceYears: 3,
    responseTime: "Отвечает в течение часа",
    location: "Ростов-на-Дону · Удалённо",
    services: [
      {
        title: "Telegram-бот с AI-консультантом и оплатой",
        priceFrom: "От 38 000 ₽",
        durationFrom: "от 8 дней",
      },
    ],
    reviews: [
      {
        author: "Марат, сеть маникюрных студий",
        rating: 4,
        text: "Бот записывает клиентов и принимает предоплату — администратор освободился от половины звонков.",
      },
    ],
  },
];
